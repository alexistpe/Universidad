Algoritmo cajeroFinal
	...
	Definir f, u, t, d, m, mx, cu Como Entero //Bucle, (u = opciones), total, dinero, maximo, maximobilletes, cuenta (numero)
	Dimensionar b2[6]
	Dimensionar din[1000]
	...
	Para i <- 1 hasta 1000
		din[i] = 50000 //Ingresa el dinero en cada cuenta (Simulado).
	FinPara
	...
	Mientras f == 0
		Mientras a = 0
			...
			Para i <- 1 Hasta 1000 //Itera por los usuarios.
				si c[i] == p
					cu = i
					Escribir "Bienvenido usuario ", cu
					a = 1 //Accede
				FinSi
			FinPara
		...
		Segun u
			1: 
				...
				Leer d //Dinero
				si d MOD 10 <> 0 o d < 0 o d > m
					Escribir "Error, ingrese multiplos de 10, positivo y un monto menor a ", m
				SiNo
					...
					si d > t o d > din[cu]
						...
						si d > din[cu]
							Escribir "Saldo de cuenta insuficiente"
						FinSi
